  ...
  return (
    <div className="max-w-md mx-auto mt-10 shadow-xl bg-white py-8 px-6 rounded-lg">
      ...
      <div className="flex flex-col mb-4 gap-3">
        ...
        <input type="email" name="email" id="email" placeholder="Enter your email" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:border-blue-500" />
      </div>
